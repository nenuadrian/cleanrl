...
def mpo():
    import cleanrl.mpo_continuous_action
    import cleanrl_utils.evals.mpo_continuous_action_eval

    return (
        (cleanrl.mpo_continuous_action.Critic,),
        cleanrl.mpo_continuous_action.make_env,
        cleanrl_utils.evals.mpo_eval.evaluate,
    )
