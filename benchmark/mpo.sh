...
uv run python -m cleanrl_utils.benchmark \
    ...
    --command "uv run python cleanrl/mpo_continuous_action.py --track --capture_video  --wandb_project_name cleanrl-bench-1" \
    --num-seeds 1 \
    --workers 2
...
uv run python -m cleanrl_utils.benchmark \
    ...
    --command "uv run python cleanrl/mpo_continuous_action.py  --track  --wandb_project_name cleanrl-bench-1" \
    --num-seeds 1 \
    --workers 2
